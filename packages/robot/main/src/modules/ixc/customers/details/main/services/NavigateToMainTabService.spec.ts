...
import NavigateToMainTabService from './NavigateToMainTabService';
...
let navigateToMainTab: NavigateToMainTabService;

let browser: Browser;
let page: Page;

describe('NavigateToMainTab', () => {
  beforeAll(async () => {
  ...
  beforeEach(async () => {
    ...
    navigateToMainTab = new NavigateToMainTabService(page);
  });
  ...
  it('should be able to navigate to contact tab', async () => {
