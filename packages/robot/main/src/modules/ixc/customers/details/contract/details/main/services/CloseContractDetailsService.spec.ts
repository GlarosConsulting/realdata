...
import CloseContractDetailsService from './CloseContractDetailsService';
import OpenContractDetailsService from './OpenContractDetailsService';
...
let closeContractDetails: CloseContractDetailsService;

let browser: Browser;
let page: Page;

describe('CloseContractDetails', () => {
  beforeAll(async () => {
  ...
  beforeEach(async () => {
    ...
    closeContractDetails = new CloseContractDetailsService(page);
  });
