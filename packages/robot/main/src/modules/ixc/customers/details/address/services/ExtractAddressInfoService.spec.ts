...
import ExtractAddressInfoService from './ExtractAddressInfoService';
import NavigateToAddressTabService from './NavigateToAddressTabService';
...
let navigateToAddressTab: NavigateToAddressTabService;
let extractAddressInfo: ExtractAddressInfoService;
...
describe('ExtractAddressInfo', () => {
  ...
  beforeEach(async () => {
    ...
    navigateToAddressTab = new NavigateToAddressTabService(page);
    extractAddressInfo = new ExtractAddressInfoService(page);
  });
  ...
  it('should be able to extract contact info', async () => {
    ...
    const address = await extractAddressInfo.execute();
