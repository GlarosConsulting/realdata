...
import CloseCustomerDetailsService from './CloseCustomerDetailsService';
...
let closeCustomerDetails: CloseCustomerDetailsService;

let browser: Browser;
let page: Page;

describe('CloseCustomerDetailsService', () => {
  beforeAll(async () => {
  ...
  beforeEach(async () => {
    ...
    closeCustomerDetails = new CloseCustomerDetailsService(page);
  });
  ...
  it('should be able to close customer details', async () => {
