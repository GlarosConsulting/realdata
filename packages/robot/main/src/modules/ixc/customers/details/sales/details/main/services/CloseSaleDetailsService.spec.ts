...
import CloseSaleDetailsService from './CloseSaleDetailsService';
...
let closeSaleDetails: CloseSaleDetailsService;

let browser: Browser;
let page: Page;

describe('CloseSaleDetails', () => {
  beforeAll(async () => {
  ...
  beforeEach(async () => {
    ...
    closeSaleDetails = new CloseSaleDetailsService(page);
  });
  ...
  it('should be able to close sale details', async () => {
