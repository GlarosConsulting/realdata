...
import ExtractDetachedFinancialListService from './ExtractDetachedFinancialListService';
import NavigateToDetachedFinancialTabService from './NavigateToDetachedFinancialTabService';
...
let navigateToDetachedFinancialTab: NavigateToDetachedFinancialTabService;
let extractDetachedFinancialList: ExtractDetachedFinancialListService;

let browser: Browser;
let page: Page;

describe('ExtractDetachedFinancialList', () => {
  beforeAll(async () => {
  ...
  beforeEach(async () => {
    ...
    navigateToDetachedFinancialTab = new NavigateToDetachedFinancialTabService(
      page,
    );
    extractDetachedFinancialList = new ExtractDetachedFinancialListService(
      page,
    );
  });
  ...
  it('should be able to extract detached financial', async () => {
    ...
    const financial = await extractDetachedFinancialList.execute();
